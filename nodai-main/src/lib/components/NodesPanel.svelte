...
<Panel label="Network">
	...
	{:else if nodes.length === 0}
		<p class="text-[0.9375rem] leading-relaxed text-fg-muted">
			No community GPU online.
			<a href="/host" class="text-accent-fg underline underline-offset-4 hover:text-fg">Host yours</a>
			with <span class="font-mono text-fg">nodai-node start</span>.
		</p>
	{:else}
